...
const NavigationItem = ({ menu, className, onNavigate }: NavigationItemProps) => {
  return (
    <Link
      href={menu.href}
      onClick={() => onNavigate?.()}
      className={`group flex items-center gap-2 rounded px-2 p-2 text-sm text-gray-900 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-100 ${
