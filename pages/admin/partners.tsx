...
const PartnerCompaniesPage = () => {
 ...
 return (
 <div key={company.id} className="rounded-xl border overflow-hidden">
 ...
 <span key={sa.siteId} className="rounded-full border px-2 py-0.5 text-xs text-gray-300">
 ...
 {/* 수정 폼 */}
 {isEditing && (
 <div className="mb-4 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3 rounded-lg border p-3">
 <Field label="사업자번호">
