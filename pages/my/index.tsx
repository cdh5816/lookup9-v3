...
const ApprovalsTab = () => {
 ...
 <div key={item.id} className="rounded-xl border p-3 opacity-70">
...
const LeaveTab = () => {
 ...
 <div key={b.label} className="rounded-xl border p-4 text-center">
...
const WorkLogTab = () => {
 ...
 : 'hover: border border-transparent text-gray-300'
 }`}
 >
...
const MySitesTab = ({ sites }: { sites: any[] }) => {
 ...
 <div className="rounded-xl border p-4  transition cursor-pointer">
...
const ActivityTab = ({ comments }: { comments: any[] }) => {
 ...
 <div className="flex items-start justify-between gap-3 rounded-lg border px-3 py-2.5 hover: cursor-pointer">
