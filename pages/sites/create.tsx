        ...
        {mode === 'single' ? (
          <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_360px]">
            ...
            <div className="space-y-5">
              ...
              {/* 기본정보 */}
              <div className="rounded-xl border border-gray-800 bg-black/20 p-5 space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {siteStatuses.map((s) => (
                      <button key={s} type="button" onClick={() => setForm({ ...form, status: s })}
                        className={`flex items-center gap-1.5 rounded-full border px-3 py-1 text-sm transition ${form.status === s ? 'border-blue-500 bg-blue-900/30 text-blue-300' : 'border-gray-700 text-gray-400 hover:border-gray-500'}`}>
              ...
              <div className="rounded-xl border border-blue-900/40 bg-blue-950/20 p-5 space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                  <div>
                    ...
                    <input type="text" className="input input-bordered w-full bg-gray-900/40 font-semibold text-blue-300"
                      placeholder="자동계산"
            ...
            {/* 오른쪽: 담당자 배정 */}
            <div className="rounded-xl border border-gray-800 bg-black/20 p-5 space-y-4 h-fit">
              <div>
              ...
              {assignees.length > 0 && (
                <div className="flex flex-wrap gap-2">
                  {assignees.map((u) => (
                    <span key={u.id} className="badge badge-lg gap-1 border-gray-700">
              ...
              <div className="rounded-lg border border-gray-800 px-3 py-2.5 text-xs text-gray-500">
          ...
          /* 엑셀 일괄등록 */
          <div className="rounded-xl border border-gray-800 bg-black/20 p-5 space-y-4">
            <div className="rounded-lg bg-gray-900/60 px-4 py-3 text-sm text-gray-300 leading-6">
