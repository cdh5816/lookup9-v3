...
const WorklogsPage = () => {
 ...
 <span className="shrink-0 rounded-full border px-1.5 py-0.5 text-[10px] text-gray-400">
 ...
 {!selectedUser ? (
 <div className="flex min-h-[360px] items-center justify-center rounded-xl border border-dashed text-sm text-gray-500">
 ...
 <div className="flex min-h-[360px] items-center justify-center rounded-xl border">
